...
import { message } from "@/pages/api/actions";

export default function Home({ initialTables }: { initialTables: string[] }) {
  console.log("Initial tables:", initialTables);
  ...
  const [messages, setMessages] = useState<BaseMessage[]>([
    new SystemMessage(`
      ...
      You should create a PostgreSQL query based on natural language. 
